...
export const BASELINE_ENV_KEYS = ['PATH', 'HOME', 'USER', 'LOGNAME', 'SHELL', 'TMPDIR', 'TMP', 'TEMP', 'NODE_PATH', 'SHROK_WORKSPACE_PATH', 'WORKSPACE_PATH', 'SHROK_ENV_FILE', 'SHROK_ROOT', 'SHROK_SKILLS_DIR', 'TZ']
