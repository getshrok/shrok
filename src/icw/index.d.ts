import type { Message, Topic, RetrieveResult, MemoryOptions } from './types.js';
...
export declare class Memory {
    ...
    private ensureInit;
    chunk(conversation: Message[]): Promise<void>;
    retrieve(query: string, tokenBudget?: number): Promise<RetrieveResult[]>;
    retrieveByEntity(entityName: string, tokenBudget?: number): Promise<RetrieveResult[]>;
    retrieveByIds(requests: Array<{
        topicId: string;
        budgetTokens: number;
    }>): Promise<RetrieveResult[]>;
    compact(topicId?: string): Promise<void>;
