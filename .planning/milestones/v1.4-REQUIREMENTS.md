# Requirements Archive — v1.4 Unmissable Reminders

> **Archived 2026-05-24** at milestone close. This is the frozen v1.4 requirements set,
> copied verbatim from `.planning/REQUIREMENTS.md` before it was removed to make way for
> the next milestone. All 13 v1.4 requirements shipped (13/13 mapped, 0 unmapped).
...
- [x] **SCHED-04**: The `create_reminder` tool description accurately documents that `triggerAt` + `cron` together produce start-then-repeat behavior

## Future Requirements

Acknowledged but deferred — carried forward past v1.4.
...
---
*Requirements defined: 2026-05-23 — archived 2026-05-24 at v1.4 milestone close*
